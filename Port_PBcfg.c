...
const Port_ConfigType Port_Configuration = {
                                            ...
                                            PORTF , PIN1 ,PORT_PIN_OUT , NO_PULL_UP_DOWN ,PORT_LEVEL_Digital , STD_LOW   ,PORT_DEFAULT_MODE_GPIO,MODE_DIS_CHANGE,DIRECTION_EN_CHANGE,   //LED PORTF1 
                                            ...
                                            PORTF , PIN4 ,PORT_PIN_IN  , PULL_UP         ,PORT_LEVEL_Digital , STD_HIGH  ,PORT_DEFAULT_MODE_GPIO,MODE_DIS_CHANGE ,DIRECTION_EN_CHANGE, //BUTTON PORTF4      
				         };